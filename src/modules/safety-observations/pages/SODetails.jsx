  ...
  return (
    <div className="mod-page">
      <div style={{ marginBottom: 24 }}>
        <button
          onClick={() => navigate("/safety-observations/list")}
          style={{ background: "none", border: "none", color: "var(--nne-brand-blue)", cursor: "pointer", display: "flex", alignItems: "center", gap: 6, fontSize: 14, padding: 0 }}
        >
