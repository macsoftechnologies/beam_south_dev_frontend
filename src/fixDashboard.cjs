const fs = require('fs');
const file = 'd:/Projects/React/Beam/Development/Beam2.o_South_Incidents/src/modules/safety-observations/pages/SODashboard.jsx';

let content = `import React, { useRef, useEffect } from "react";
